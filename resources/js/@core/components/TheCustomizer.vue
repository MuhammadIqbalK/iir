...
<template>
  <div class="d-lg-block d-none">
    <VBtn
      icon
      class="rounded-s-lg rounded-0"
      style="position: fixed; z-index: 1001; inset-block-end: 10px; inset-inline-end: 10px;"
    ...
    >
      ...
      <div class="customizer-heading d-flex align-center justify-space-between">
        <div>
          <h6 class="text-h6">
            Theme Customizer || Pengubah Tema
          </h6>
          <p class="text-body-2 mb-0">
            Customize & Preview in Real Time 
          </p>
          <p class="text-body-2 mb-0">
            Mengubah & Preview dalam Real Time
          </p>
        </div>
